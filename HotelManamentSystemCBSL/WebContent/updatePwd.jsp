...
<html>
	...
	<body>
		...
		<!-- content start -->
		<div style="overflow: hidden;" class="admin-content">
			<div class="admin-content-body">
				<div class="am-g">
				
					<form class="am-form am-form-horizontal" action="updateCurrentPassword"
						 method="post"
						...
						<div class="am-form-group">
							<div class="am-u-sm-9 am-u-sm-push-3">
								<input onclick="delpwd()" type="submit" class="am-btn am-btn-success" value="修改密码" />
							</div>
							<div  class="am-u-sm-9 am-u-sm-push-3">
							<!-- style="border: 1px solid red"s -->
							</div>
						</div>
					</form>
